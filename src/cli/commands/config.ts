...
export async function configShowCommand(): Promise<void> {
  ...
  console.log(chalk.white('  Provider:      ') + chalk.bold(PROVIDER_DISPLAY_NAMES[config.defaultProvider]));
  ...
  console.log(chalk.white('  Explanations:  ') + chalk.bold(config.preferences.showExplanations ? 'Yes' : 'No'));
